...
//    // Add this line to store room reference
...
//        {
//            _roomGenerator.RegisterBossAltar(this);
//        }
//        else
//        {
...
//        _activated = true;
//        if (stoneStatue != null) stoneStatue.SetActive(false);

//        if (_roomGenerator != null) _roomGenerator.ActivateBarriers(this);

//        if (bossPrefab != null)
//        {
//            _currentBoss = Instantiate(bossPrefab, transform.position, Quaternion.identity);
//            var enemyAI = _currentBoss.GetComponent<EnemyAI>();
//            if (enemyAI != null) enemyAI.isBoss = true;
//        }
//    }

//    void Update()
//    {
//        if (_activated && (_currentBoss == null || !_currentBoss.activeSelf))
//        {
//            if (_roomGenerator != null) _roomGenerator.DeactivateBarriers(this);
//            enabled = false;
//        }
//    }
//}
...
//    {
//        // Clear previous boss rooms
//        bossRooms.Clear();

//        // Get 4 largest rooms
//        var potentialBossRooms = mainRooms.OrderByDescending(r => r.width * r.height).Take(4).ToList();

//        foreach (Room room in potentialBossRooms)
//        {
//            if (bossAltarPrefab == null)
//            {
//                Debug.LogError("BossAltar prefab not assigned!");
//                continue;
//            }

//            // Spawn altar in center of boss room
...
//                bossRooms.Add(room);
//                RegisterBossAltar(bossAltar);
//            }
//            else
//            {
//                Debug.LogError("BossAltar component missing on prefab!");
//                Destroy(altar);
//            }
//        }
//    }
...
//        {
//            GameObject fence = Instantiate(fencePrefab, new Vector3(x, y, 0), Quaternion.identity, _wallParent);
...
//        //{
//        //    if (_floorTileTypes.TryGetValue(tile, out int type))
//        //    {
//        //        Gizmos.color = type == 1 ? Color.green :
//        //                      type == 2 ? Color.blue :
//        //                      Color.magenta;
//        //        Gizmos.DrawCube(new Vector3(tile.x, tile.y, 0), Vector3.one * gridSize);
//        //    }
//        //}
...
//        //{
//        //    Gizmos.DrawWireCube(new Vector3(tile.x, tile.y, 0), Vector3.one * gridSize);
//        //}
//    }
//}
